...
import chat.client.ChatClientListener;
...
public class ChatPanel extends JPanel implements ChatClientListener {
    ...
    /** Component extension area */
    private JPanel extensionArea = new JPanel();
    ...
    public ChatPanel(ChatClient client) {
        ...
        // This part will be changed to fit the requirement
    ...
    public void setExtensionArea(JPanel extenComponent) {
        extensionArea = extenComponent;
        add(extensionArea, BorderLayout.NORTH);
    }
}
